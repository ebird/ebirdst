---
title: "eBird Status & Trends Data Products Changelog"
author: "Tom Auer"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{eBird Status & Trends Data Products Changelog}
...
#### Ensemble
- CHANGED: The residual confounding adjustment now includes two components: a global adjustment and a spatially explicit adjustment. Both adjustments are linear transformations derived by comparing the actual and estimated trends for the simulations. The global trend is calculated and applied across the entire species range, while the spatially explicit adjustment is calculated and applied separately for each pixel.
