...
##### Prediction
- CHANGED: We have transitioned to a new 3 km X 3 km prediction grid in the widely used [Equal Earth equal area projection](https://equal-earth.com). Previously the predictions were made to a 2.96 km X 2.96 km prediction grid using a non-standard sinusoidal projection.
