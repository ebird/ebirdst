...
- Submit an issue on the Issues page
  [here](https://github.com/ebird/ebirdst/issues)
...
- Clone your version on your account down to your machine from your
  account, e.g,.
  `git clone https://github.com/<yourgithubusername>/ebirdst.git`
- Make sure to track progress upstream (i.e., on our version of
  `ebirdst` at `ebird/ebirdst`) by doing
  `git remote add upstream https://github.com/ebird/ebirdst.git`. Before
...
- If you alter package functionality at all (e.g., the code itself, not
  just documentation) please do write some tests to cove the new
  functionality.
