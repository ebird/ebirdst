...
- [Introduction to eBird Status & Trends Data](https://ebird.github.io/ebirdst/articles/ebirdst.html): covers data access, available data products, and structure and format of data files.
- [Working with Raster Data](https://ebird.github.io/ebirdst/articles/rasters.html): loading and analyzing the raster data products. 
